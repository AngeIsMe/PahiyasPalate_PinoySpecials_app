...
class LunchAdapter : RecyclerView.Adapter<LunchAdapter.RecipeViewHolder>() {

    private var category: List<LunchDomain> = emptyList()

    fun setData(category: MutableList<LunchDomain>) {
