...
public class DinnerDomain {
    ...
    public DinnerDomain(String id, String name, String category, String recipe_description, String level, String steps, String ingredients, String views, String author, String imageUrl) {
        this.id = id;
        this.name = name;
        this.category = category;
        this.recipe_description = recipe_description;
