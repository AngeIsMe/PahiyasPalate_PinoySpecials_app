...
class LunchAdapter(private val context: Context, private val viewModel: LunchViewModel) : RecyclerView.Adapter<LunchAdapter.RecipeViewHolder>() {
    ...
    private var recipes: List<LunchDomain> = emptyList()

    fun setData(Lunch: List<LunchDomain>) {
        this.recipes = Lunch
