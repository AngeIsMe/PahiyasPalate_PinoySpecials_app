...
class BreakfastAdapter(private val context: Context, private val viewModel: BreakfastViewModel) : RecyclerView.Adapter<BreakfastAdapter.RecipeViewHolder>() {
    ...
    private var recipes: List<BreakfastDomain> = emptyList()

    fun setData(breakfast: List<BreakfastDomain>) {
        this.recipes = breakfast
