...
class DinnerAdapter : RecyclerView.Adapter<DinnerAdapter.RecipeViewHolder>() {

    private var category: List<DinnerDomain> = emptyList()

    fun setData(category: MutableList<DinnerDomain>) {
